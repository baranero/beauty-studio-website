      ...
      <div className="text-center absolute bg-gray-600/60 h-full w-full flex">
        <div className="my-auto lg:w-[50%] lg:mx-auto">
          ...
          <p className="text-center text-sm mx-4 lg:text-base">
            ...
            dobraną do potrzeb twojej skóry, dobrą atmosferę i kojący klimat co
            wpływa zarówno na ciało jak i ducha.
          </p>
          <button className="bg-[#96939B] text-[#080F29] mt-10 w-48 p-4 mx-auto hover:bg-[#727272] delay-100 ease-in"><a href="#services">Dowiedz się więcej</a></button>
        </div>
      </div>
    </section>
  );
